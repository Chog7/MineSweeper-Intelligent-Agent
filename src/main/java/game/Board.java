...
public class Board {
    ...
    private void placeMines(int firstClickX, int firstClickY) {
        ...
        // Only enforce the "first click is a zero" rule if the board is big enough to
        // support it
        ...
        while (minesPlaced < numMines) {
            ...
            // Ensure we don't place a mine on the first clicked area or if there's already
            // a mine
    ...
    public void reveal(int x, int y) {
        if (isGameOver || isGameWon || !isValidCoordinate(x, y))
            return;
    ...
    public int getUnrevealedSafeTiles() {
        return unrevealedSafeTiles;
    }
